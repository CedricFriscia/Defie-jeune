      ...
      <div className='landing'>
         ...
         <section className='landing__présentation'>
            ...
            <p>
               ...
               de se contenter de répondre aux questions des recruteurs, les
               candidats prennent l'initiative de poser des questions
         ...
         <section className='landing__événements'>
            <h2 className='landing__titles'>
               Des animations, un espace détente, et bien sûr des jeunes à
               recruter.
            </h2>
            <img
